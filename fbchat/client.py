...
class Client(object):
    ...
    def fetchThreadList(self, offset=0, limit=20):
        ...
        for k in j['payload']['threads']:
            ...
            elif k['thread_type'] == 5:
                # Special edge case, have some weird threads with thread_type 5:
                # A thread had an unknown thread type: {u'approval_queue_ids': [], u'lightweight_event': None, u'thread_type': 5, u'is_subscribed': True, u'last_message_timestamp': 1476153251093, u'custom_color': None, u'other_user_fbid': None, u'thread_id': u'mid.1476153248295:aa0e048e61', u'rtc_call_data': {u'call_state': u'NO_ONGOING_CALL', u'initiator_fbid': 0, u'server_info_data': u''}, u'recipients_loadable': True, u'mayorship_mode': 0, u'read_only': False, u'has_email_participant': False, u'participant_add_mode': u'ADD', u'server_timestamp': 1476153251093, u'message_count_milestone': 0, u'last_read_timestamp': 1476153251093, u'is_canonical_user': False, u'admin_ids': [], u'snippet': u'Would you accept $1?', u'participants': [u'fbid:520918660', u'fbid:1534110256'], u'is_thread_queue_enabled': True, u'reactions_mute_mode': 0, u'customization_enabled': True, u'folder': u'inbox', u'is_canonical': False, u'mentions_mute_mode': 0, u'ephemeral_ttl_mode': 0, u'approval_mode': 0, u'timestamp': 1476153251093, u'last_message_type': None, u'can_reply': True, u'thread_fbid': u'1195115870560698', u'message_count': 3, u'associated_object': None, u'custom_nickname': None, u'mute_until': None, u'timezone_warning_dismiss_count': {}, u'snippet_attachments': [], u'joinable_mode': {u'link': u'', u'mode': 0}, u'name': u'Nikil \xb7 Gluten Free Pizza# Last Slice# Still Warm', u'custom_like_icon': None, u'work_user_warning_dismiss_count': {}, u'unread_count': 0, u'group_mayor_id': 0, u'is_archived': False, u'is_pin_protected': False, u'cannot_reply_reason': None, u'image_src': u'https://scontent-sjc2-1.xx.fbcdn.net/v/t34.0-12/s720x720/14686618_10153972527137844_1444456425_n.jpg?oh=95249583228c1b6de93b6d9db8818029&oe=598B42FD', u'snippet_sender': u'fbid:1534110256'}
                continue
            else:
